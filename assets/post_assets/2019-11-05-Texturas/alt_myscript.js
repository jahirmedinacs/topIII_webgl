function webgl_scene2(){
  ...
  function main(objDATA) {
    ...
    const programInfo2 = {
      ...
      attribLocations: {
        ...
        textureCoord: gl2.getAttribLocation(shaderProgram, 'aTextureCoord'),
      },
      uniformLocations: {
        ...
        uSampler: gl2.getUniformLocation(shaderProgram, 'uSampler'),
      },
    };
    ...
    function render(now) {
      ...
      const deltaTime2 = now - then;
      then = now;



      drawScene(gl2, programInfo2, buffers2, texture2, deltaTime2);
  ...
  function initBuffers(gl, objDATA) {
    ...
    var prev_positions = objDATA.positions // AQUI  SE INTENTO CARGAR DESDE JSON PERO DA UN ERROR DE INDICES
    const positions = prev_positions.map(function(x) {return x * scaleRatio;})
